...
class MCTSNode extends State {
	...
	MCTSNode expansion() {
		...
		MCTSNode newNode = new MCTSNode(this, this);
...
public class MCTSPlayer extends Player {
	...
	Card performAction(State masterCopy) {
		...
		while (System.currentTimeMillis() - start < timeLimitInMillis) {
			MCTSNode tNode = root.selection();
			MCTSNode cNode = tNode.expansion();
			ArrayList<Integer> rewards = cNode.simulation();
